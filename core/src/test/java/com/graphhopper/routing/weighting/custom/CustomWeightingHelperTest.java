...
class CustomWeightingHelperTest {
    ...
    public void testInRectangle() {
        ...
        g.getNodeAccess().setNode(0, 1, 1, 0);
        g.getNodeAccess().setNode(1, 3, 3, 0);
        ...
        g.getNodeAccess().setNode(2, 0, 0, 0);
        g.getNodeAccess().setNode(3, 20, 20, 0);
        edge = g.edge(2, 3).setWayGeometry(Helper.createPointList(20, 0));
        assertTrue(CustomWeightingHelper.in(square, edge));

        // (0,30) (10,40) (20,50)
        // Edge is outside the polygon; BBoxes are not intersecting
        g.getNodeAccess().setNode(4, 0, 30, 0);
        g.getNodeAccess().setNode(5, 20, 50, 0);
        ...
        g.getNodeAccess().setNode(6, 0, 30, 0);
        g.getNodeAccess().setNode(7, 30, 0, 0);
