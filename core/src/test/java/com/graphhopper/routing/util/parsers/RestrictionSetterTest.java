...
//        assertPath(3, 4, nodes(3, 1, 2, 1, 4));
    ...
    void artificialEdgeSnapping() {
        ...
        na.setNode(0, 40.03, 5.03, 0);
        na.setNode(1, 40.02, 5.01, 0);
        na.setNode(2, 40.02, 5.02, 0);
        na.setNode(3, 40.02, 5.03, 0);
        na.setNode(4, 40.02, 5.04, 0);
        na.setNode(5, 40.01, 5.02, 0);
        na.setNode(6, 40.03, 5.02, 0);
        na.setNode(7, 40.01, 5.03, 0);
    ...
    void artificialEdgeSnapping_twoVirtualNodes() {
        ...
        na.setNode(3, 40.02, 5.03, 0);
        na.setNode(4, 40.02, 5.04, 0);
        na.setNode(5, 40.02, 5.05, 0);
        na.setNode(6, 40.02, 5.06, 0);
        assertPath(1, 4, nodes(1, 2, 3, 4));
